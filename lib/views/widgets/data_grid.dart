...
//       case List<Product>:
//         setState(() {
//           widget.data.cast<Product>();
//         });
//         break;
//       case List<Event>:
//         setState(() {
//           widget.data.cast<Event>();
//         });
//         break;
//     }
...
//   ProductDataSource({List<dynamic> objects = const []}) {
//     switch (objects.runtimeType) {
//       case List<Product>:
//         final temp = objects.cast<Product>();
//         _products.clear();
//         _products = temp
//             .map<DataGridRow>(
//               (e) => DataGridRow(
